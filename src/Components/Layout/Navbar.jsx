...
export default function Navbar({ title = "Dashboard", onNotifClick, unreadCount = 0, notifPanel }) {
    ...
    <motion.header
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs"
          ...
          <span style={{ color: isConnected ? "#00ff88" : "#ff3366", fontFamily: "JetBrains Mono" }}>
        ...
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold flex-shrink-0"
            style={{ background: "linear-gradient(135deg,#00d4ff,#7c3aed)", fontFamily: "Orbitron", color: "#000", fontSize: 11 }}>
            {initials}
          </div>
